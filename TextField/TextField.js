...
var getStyles = function getStyles(props, context, state) {
  ...
  if (state.hasValue) {
    ...
    styles.floatingLabelAsterisk.color = (0, _colorManipulator.fade)(props.disabled ? disabledTextColor : floatingLabelColor, 0.5);
  }
...
var TextField = function (_Component) {
  ...
  (0, _createClass3.default)(TextField, [{
    ...
    value: function render() {
      ...
      var other = (0, _objectWithoutProperties3.default)(_props2, ['children', 'className', 'disabled', 'errorStyle', 'errorText', 'floatingLabelFixed', 'floatingLabelFocusStyle', 'floatingLabelStyle', 'floatingLabelText', 'fullWidth', 'hintText', 'hintStyle', 'id', 'inputStyle', 'isRequired', 'multiLine', 'onBlur', 'onChange', 'onFocus', 'style', 'type', 'underlineDisabledStyle', 'underlineFocusStyle', 'underlineShow', 'underlineStyle', 'rows', 'rowsMax', 'textareaStyle']);
      ...
      var floatingLabelTextElement = floatingLabelText && _react2.default.createElement(
        _TextFieldLabel2.default,
        {
          ...
          asteriskStyle: (0, _simpleAssign2.default)(styles.floatingLabelAsterisk),
